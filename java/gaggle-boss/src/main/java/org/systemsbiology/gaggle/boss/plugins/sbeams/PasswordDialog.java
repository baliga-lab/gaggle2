...
public class PasswordDialog extends JDialog {
    ...
    public void setPasswordFocus() { this.pass.requestFocus(); }
    public void setUsernameFocus() { this.name.requestFocus(); }
    public void setName(String name) { this.name.setText(name); }
    public void setPass(String pass) { this.pass.setText(pass); }
    ...
    public boolean okPressed() { return pressed_OK; }
