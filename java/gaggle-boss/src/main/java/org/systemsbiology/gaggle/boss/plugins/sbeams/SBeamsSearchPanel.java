...
public class SBeamsSearchPanel extends GaggleBossPlugin {
    ...
    private static final String PLUGIN_NAME = "SBEAMS Search Panel";
    private String targetGoose = "Boss";   // for broadcasts
    ...
    private JPanel createSbeamsResultSetTable() {
    ...
    class BroadcastSbeamsSelectionAction extends AbstractAction {
        ...
        public void actionPerformed (ActionEvent e) {
            ...
            gaggleBoss.broadcastNamelist(PLUGIN_NAME, targetGoose, nameList);
        }
    }
    ...
    private void performSearch() {
        ...
        if (searchText.length() > 0) {
            ...
            if (results.length > 0) {
                ...
                retrievedCountReadout.setText(String.valueOf(results.length));
            }
    ...
    private String[] doSbeamsSearch(String searchText) {
        try {
        ...
        if (lines.length <= 1) return new String[] {"no match\t\t\t"};
     ...
     * result table.
     */
    private void selectMatchingRow(String name) {
    ...
    class SelectionListener implements ListSelectionListener {
        ...
        public void valueChanged(ListSelectionEvent e) {
            if (!e.getValueIsAdjusting()) {
                ...
                selectionCountReadout.setText(String.valueOf(count));
            }
        }
    }
}
