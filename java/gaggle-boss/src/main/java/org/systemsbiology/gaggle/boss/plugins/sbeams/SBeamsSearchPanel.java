    ...
    class BroadcastSbeamsSelectionAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            for (int i = 0; i < selectedRows.length; i++) {
                String orfName = (String)
                    sbeamsResultSetTableModel.getValueAt(selectedRows[i], 0);
    ...
    protected void performSearch() {
        ...
        if (searchText.length() > 0) {
            ...
            for (int i = 0; i < results.length; i++) {
                ...
                annotations.add(new Annotation(orf, geneSymbol, ecNumbers,
                                               function, domainHitsUrl));
            }
